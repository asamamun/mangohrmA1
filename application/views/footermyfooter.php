...
<footer class="main-footer">
	...
	<script src="<?php echo base_url('assetss/datatables/js/jquery.dataTables.min.js')?>"></script>
<script src="<?php echo base_url('assetss/datatables/js/dataTables.bootstrap.js')?>"></script>
	<script>
